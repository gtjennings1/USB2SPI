...
-- Module  Version: 5.4
--C:\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_60MHz -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 12 -fclkop 60 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -rst -fb_mode 1 -lock -e 
...
entity pll_60MHz is
 ...
 attribute dont_touch of pll_60MHz : entity is true;
end pll_60MHz;

architecture Structure of pll_60MHz is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  8, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  9, CLKFB_DIV=>  5, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll_60MHz is
    for Structure
